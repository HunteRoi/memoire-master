...
\paragraph{Feature 2.1 - Détection et suivi des zones de couleur}
...
%\subsubsection{Epic 4 - Observation et comportements collectifs}

%\paragraph{Feature 4.1 - Coordination entre plusieurs robots}  
%\subparagraph{\acrshort{us} 4.1.1} Lorsque plusieurs robots interagissent, je veux qu’ils puissent synchroniser leurs actions afin de réaliser des comportements coordonnés.
%\subparagraph{\acrshort{us} 4.1.2} Lorsque deux robots participent à une simulation de poursuite, je veux leur attribuer un rôle de chasseur et de proie afin d’observer un scénario de type "jeu du chat et de la souris".
