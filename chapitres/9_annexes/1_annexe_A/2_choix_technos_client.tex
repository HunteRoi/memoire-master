\subsection{Choix technologiques concernant l'interface utilisateur} \label{sec:choix_client}
...
\subsubsection{Échelle d’évaluation des frameworks} \label{sec:criteria_frameworks}
