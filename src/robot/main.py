...
async def run_diagnostics():
    ...
    try:
        ...
        logging.info("="*50)
        logging.info("🔍 Test 1: I2C Address Scan")
        logging.info("="*50)
        epuck.scan_i2c_addresses()
        
        logging.info("\n" + "="*50)
        logging.info("📡 Test 2: I2C Communication Test")
        logging.info("="*50)
        comm_success = epuck.test_i2c_communication()
        
        logging.info("\n" + "="*50)
        logging.info("🔊 Test 3: Audio Test")
        logging.info("="*50)
        audio_success = epuck.test_audio()
        
        logging.info("\n" + "="*50)
        logging.info("🎵 Test 3b: Advanced Sound Testing")
        logging.info("="*50)
        epuck.test_alternate_sound_positions()
        
        logging.info("\n" + "="*50)
        logging.info("🎵 Test 3c: Audio Hardware Check")
        logging.info("="*50)
        epuck.test_audio_hardware_check()
        
        logging.info("\n" + "="*50)
        logging.info("💡 Test 4: LED Test (Pi-puck + e-puck2)")
        logging.info("="*50)
        ...
        logging.info("\n" + "="*50)
        logging.info("💡 Test 4b: Pi-puck LED Hardware Test (separate from e-puck2)")
        logging.info("="*50)
