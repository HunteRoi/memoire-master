...
export class Container {
    ...
    private constructor() {
        ...
        this._robotsConfigurationRepository = new FileSystemRobotsConfigurationRepository();
        this._manageRobotsUseCase = new ManageRobotsUseCase(this._robotsConfigurationRepository);
        this._robotConnectionUseCase = new RobotConnectionUseCase(this._robotCommunicationService);
    }
