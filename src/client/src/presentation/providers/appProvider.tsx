...
export const AppProvider: FC<PropsWithChildren> = ({ children }) => {
    ...
    const contextValue = useMemo(() => ({
        ...
        state, setTheme, setLanguage, setUserAge, setSelectedRobot, setSelectedMode,
        setRobotsList, addConnectedRobot, removeConnectedRobot, isRobotConnected, setLoading, setError,
        showAlert, hideAlert, resetState,
        ensureRobotsLoaded, ensureThemeLoaded, ensureLanguageLoaded
    ]);
